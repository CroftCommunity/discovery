...
> the iroh transport-plane claims are **verified against iroh 1.0** (wire-and-API-stable as of June 2026:
...
> governance-conflict-resolution layer (§7.3–§7.5) is matured from a **design/ENABLING** draft whose
...
itself, which may pass through multiple untrusted systems. *(Verified, RFC 9750 §8, primary text this
...
> member. *(Verified, RFC 9420 §16.4.3.)* The critical caveat dovetails with the multiple-presentation
