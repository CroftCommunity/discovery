...
| 7.6.2 | re-plant **membership** continuity: MLS group stamps exactly the fold-derived set | `Verified` | membership half; real openmls 0.8.1 | `e12_7_1/2/3_*.rs` (E12.7; **RUN-11 re-proof** 3/3 green — the discovery-RUN stamp the membership half had lacked, closing the FND-T4 §7.6.2 gap); `mls-replant` e12_* | `e12.4-byteproxy` | — |
