...
> — `thinking/geer-gating-peer.md` (refinement 2026-06-17)
...
> — `thinking/geer-gating-peer.md` (the argument against)
...
> — `thinking/revocation-authority.md` / `thinking/freshness-signal.md`
...
> — `thinking/revocation-authority.md` (ADMIN FLOOR)
...
> — `thinking/revocation-authority.md`
...
> — `thinking/membership-vs-access-the-public-door.md`
...
governance-constituent). *(COHESION §36.)* A guest pad is also the natural place for the geer to moderate,
...
> — `thinking/social-layer.md` (S5)

*Verification:* design, backed by the Twitter Circles billion-user precedent (COHESION §29). This is the
...
> — `thinking/group-privacy-lanes-design-note.md`
...
The detailed source-by-source rollup lives at the prior level, in `../alpha/BETA-ROLLUP.md` (theme 06
section): treatments, the shared-with-`04` mechanisms, the excluded "central hand on the wheel" anti-pattern,
and the surfaced open items (V3 UX control, S3, E11, geer compellability, CSAM/jurisdiction).

## Sources (alpha)

- `../alpha/thinking/abuse-resistance-and-the-rave-trap.md` **[S]** · `../alpha/thinking/geer-gating-peer.md` **[S]**
- `../alpha/thinking/failed-op-response.md` **[U]** · `../alpha/thinking/freshness-signal.md` **[S, shared 04]** ·
  `../alpha/thinking/revocation-authority.md` **[S, shared 04]**
- `../alpha/thinking/meer-superpeer-design.md` **[U]** ·
  `../alpha/thinking/membership-vs-access-the-public-door.md` **[S]**
- `../alpha/thinking/social-layer.md` **[S]** · `../alpha/thinking/group-privacy-lanes-design-note.md` **[S]**
- `../alpha/COHESION.md` §2 (V3), §29 (Twitter Circles → S5), §36 (membership-vs-access)
