# Research brief: "platforms author the relational field"

Evidence and narrative for the authorship/agency harm, organized by your six gaps.

Each item gives: the claim, the primary source, a verbatim quotable line (under 25 words) with speaker and document attribution, and an epistemic-status tag.

A short "do not use / could not source" list closes the brief.

One framing note before the items, flagged as mine, not the literature's: the strongest version of your thesis does not rest on any single large causal effect. It rests on (a) insiders stating intent, (b) the platform's own internal admission that engagement and quality diverge, (c) at least one regulator/NGO finding of downstream behavior change, and (d) honest acknowledgment that population-level attitude effects are small or contested. The disagreement in gap 5 is a feature of the case, not a hole in it.
...
Primary source: Mike Allen, "Sean Parker unloads on Facebook," *Axios*, November 9, 2017. Axios is the primary venue (Parker said it at an Axios event; Axios published the account). URL: https://www.axios.com/2017/11/09/sean-parker-unloads-on-facebook-god-only-knows-what-its-doing-to-our-childrens-brains

Verbatim line (Parker, to Axios): "It's a social-validation feedback loop ... you're exploiting a vulnerability in human psychology."

Second verbatim line (Parker, same interview): "The inventors, creators ... understood this consciously. And we did it anyway."
...
Primary source: Chamath Palihapitiya, "View From The Top" interview, Stanford Graduate School of Business, November 2017. The full talk is on Stanford GSB's official YouTube channel ("Chamath Palihapitiya, Founder and CEO Social Capital, on Money as an Instrument of Change"). Transcript corroborated by RealClearPolitics and Fortune, December 2017.

Verbatim line (Palihapitiya, Stanford GSB): "We have created tools that are ripping apart the social fabric of how society works."

Second verbatim line (same talk): "The short-term, dopamine-driven feedback loops that we have created are destroying how society works."
...
Primary source: Frances Haugen, written and oral testimony, U.S. Senate Committee on Commerce, Science, and Transportation, Subcommittee on Consumer Protection, "Protecting Kids Online," October 5, 2021. Committee-hosted PDF: https://www.commerce.senate.gov/services/files/FC8A558E-824E-4914-BEDB-3A7B1190BD49

Verbatim line (Haugen, written testimony): Facebook's leadership "won't make the necessary changes because they have put their astronomical profits before people."

Verbatim line (Haugen, oral testimony, per the Senate hearing): it is "about Facebook choosing to grow at all costs, becoming an almost trillion dollar company by buying its profits with our safety."

Epistemic status: on-record-testimony (sworn, congressional, committee-hosted primary document). This is your most legally weighty insider statement.

---

## Gap 2. Ranking change → documented downstream behavior change

### 2a. The 2018 MSI change and a Polish party's shift to negativity (your strongest new item)

Claim: After Facebook's 2018 "Meaningful Social Interactions" ranking change, at least one European political party told Facebook it had shifted its own messaging toward negativity to chase engagement, and Facebook recorded this in an internal report.

Primary source: internal Facebook documents (the "Facebook Papers" / Haugen disclosures), reported by *The Wall Street Journal* (Hagey & Horwitz, 2021) and *The Washington Post* ("Polish political parties complained Facebook favored polarized posts," Oct 27, 2021). The underlying artifact is a Facebook internal report dated ~April 2019.

Verbatim line (Washington Post, paraphrasing the Facebook internal report): one Polish party's social media team described "moving from a roughly even split of negative and positive messages, to 80% negative."

Important honesty flag: that line is a reporter's paraphrase of an internal Facebook document, not the party's own words and not the document's verbatim text. Present it as "according to Facebook's own internal report, as reported by the Washington Post," not as a direct quotation from the party.

Epistemic status: company-internal-admission (the document is Facebook's own) surfaced via investigative-reporting. The exact internal wording is not public.

### 2b. Peer-reviewed documentation of the 2018 change altering party behavior (US)

Claim: A peer-reviewed research note found local US Republican party Facebook pages saw engagement patterns shift after the late-2018 algorithm change, and situates this alongside the leaked evidence that Facebook knew negativity drove engagement.

Primary source: Kevin Reuning, Anne Whitesell & A. Lee Hannah, "Facebook algorithm changes may have amplified local republican parties," *Research & Politics* 9(2), 2022. https://journals.sagepub.com/doi/full/10.1177/20531680221103809
...
Claim: A 2024 field experiment that reranked real users' live feeds to reduce antidemocratic/partisan-animosity content measurably reduced affective polarization, demonstrating the feed composition causally shapes how people feel about political opponents.

Primary source: Tiziano Piccardi, Martin Saveski, Chenyan Jia, Jeffrey Hancock, Jeanne Tsai, Michael Bernstein, "Reranking partisan animosity in algorithmic social media feeds alters affective polarization," published in *Science* (Nov 2023 / 2024). Preprint: https://arxiv.org/pdf/2411.14652 ; Northeastern summary: https://news.northeastern.edu/2025/11/27/social-media-political-polarization-research/

Verbatim line (Piccardi/Jia et al., reported effect): reduced-exposure participants reported an angry-emotion change of "−5.05 points" and increased-exposure participants a symmetric increase, with effects in-feed but short-lived.

Epistemic status: peer-reviewed-finding. Strong because it manipulates the live feed of real users in situ, not a survey proxy. Limit to state plainly: emotion effects did not persist after the experiment ("effects were likely short-lived," per the paper).

---

## Gap 3. The emotional-contagion lineage (2014 Facebook mood study)
...
Verbatim line (Kramer, Guillory & Hancock, 2014): "When positive expressions were reduced, people produced fewer positive posts and more negative posts; when negative expressions were reduced, the opposite pattern occurred."

Verbatim line on intent/consent (same paper): the work "was consistent with Facebook's Data Use Policy, to which all users agree prior to creating an account on Facebook, constituting informed consent for this research."

### 3b. The precise limits (state these, per your own rule)

The effect sizes were tiny. The paper reports the positive-words effect at Cohen's *d* = 0.02 and the smallest cross-emotional effect at *d* = 0.001.
...
### 3c. The consent controversy

Claim: PNAS issued an Editorial Expression of Concern; the controversy was that users had no specific informed consent or opt-out, and no IRB reviewed the data collection (Cornell's IRB held it was not "engaged" in human-subjects research since the data pre-existed).

Primary source: Inder M. Verma, "Editorial Expression of Concern," *PNAS* 111(29): 10779, July 3, 2014. https://www.pnas.org/doi/10.1073/pnas.1412469111
...
### 4a. Ranked feeds that suppress most content (well documented)

Claim: News Feed has always shown a filtered subset; most friend content is omitted by the ranking algorithm. This is not contested.

Primary source: stated plainly inside the 2014 contagion paper itself (Kramer et al.): "Because people's friends frequently produce much more content than one person can view, the News Feed filters posts, stories, and activities."

Epistemic status: documented-fact (company description in a peer-reviewed paper).
...
Epistemic status: contested-or-disputed / anecdote-illustrative-only. Recommendation: do NOT lean on "shadowbanning" as evidence of the authorship harm. The documented category (4b) is far stronger and you don't need the folklore.
...
Primary source: Andrew M. Guess et al., "How do social media feed algorithms affect attitudes and behavior in an election campaign?" *Science* 381: 398–404, July 27, 2023. DOI: 10.1126/science.abp9364. Summary with effect sizes: NYU, https://www.nyu.edu/about/news-publications/news/2023/july/2020-election-studies-reveals-power-of-facebook--instagram-algor.html

Documented effects (Guess et al. 2023, per NYU summary): the chronological feed increased untrustworthy-source content by 68.8% on Facebook and decreased uncivil content by 43%, yet "did not significantly alter levels of issue polarization, affective polarization, political knowledge, or other key attitudes."

Companion null results to cite: Nyhan et al., "Like-minded sources on Facebook are prevalent but not polarizing," *Nature* 620: 137–144, 2023 (reducing like-minded content had "no measurable effects" on affective polarization). And Guess et al., "Reshares ... amplify political news but do not detectably affect beliefs," *Science* 381, 2023.

Verbatim hedge from the researchers (Stroud & Tucker, NYU statement, 2023): "changing the algorithm for even a few months isn't likely to change people's political attitudes. What we don't know is why."

Epistemic status: peer-reviewed-finding. This is the strongest opposing evidence and should be presented at full strength.

### 5b. The crucial wrinkle on 5a (represent the disagreement, per your rule)

The null result is contested on two grounds, both worth surfacing.
...
Verbatim line (Bail et al. 2018): "Republicans who followed a liberal Twitter bot became substantially more conservative posttreatment."

Limit (state it): the Democratic-shift result "was not statistically significant," and the sample was frequent Twitter users, not the general public.

Epistemic status: peer-reviewed-finding. Use this to show you understand the mechanism is not "more exposure = more agreement," which makes the rest of your case more credible.
...
Primary sources:
(1) UN Independent International Fact-Finding Mission on Myanmar, March 2018 (chair Marzuki Darusman, remarks to press / HRC submission).

(2) Amnesty International, *The Social Atrocity: Meta and the Right to Remedy for the Rohingya*, ASA 16/5933/2022, September 2022. https://www.amnesty.org/en/documents/asa16/5933/2022/en/

Verbatim line (Darusman, UN FFM chair, March 2018, to reporters): "As far as the Myanmar situation is concerned, social media is Facebook, and Facebook is social media."

Verbatim line (Amnesty International, *The Social Atrocity*, 2022): "Meta's algorithms proactively amplified and promoted content which incited violence, hatred, and discrimination against the Rohingya."

Verbatim human line (Sawyeddollah, 21-year-old Rohingya refugee, to Amnesty International, 2022): "I saw a lot of horrible things on Facebook ... Then I realized ... Facebook is also responsible."

Epistemic status: investigative-reporting + on-record findings (UN body; Amnesty legal analysis). Causation framing: both bodies use "determining role" / "substantially contributed," not sole cause. Keep that wording.

### 6b. The Panzagar "flower speech" stickers (the perfect compact illustration)

Claim: In 2014 Myanmar activists, with Facebook's help, released anti-hate "flower speech" stickers to post on hateful content as pushback. Facebook's algorithm read the stickers as positive engagement and *boosted* the very posts they were meant to counter.

Primary source: Amnesty International, *The Social Atrocity*, 2022 (same document as 6a).
...
## Gap 7. New threads the gathered evidence points to (follow-ups)
...
### 8a. The mechanism claim (engagement optimization rewards extremity)

Claim: Because content that approaches the policy line gets disproportionate engagement, an optimizer that maximizes engagement will, absent correction, surface progressively more provocative material.
...
Claim: Controlled "sock puppet" audits that isolate the algorithm find it recommends ideologically congenial content, and that congeniality deepens along the watch trail for right-leaning users.

Primary source: Muhammad Haroon, Magdalena Wojcieszak, et al., "Auditing YouTube's recommendation system for ideologically congenial, extreme, and problematic recommendations," *PNAS* 120(50): e2213020120, Dec 2023. DOI: 10.1073/pnas.2213020120.

Verbatim line (Haroon et al., 2023): "YouTube's algorithm recommends congenial content to its partisan users ... and ... congenial recommendations increase deeper in the trail for right-leaning users."

Epistemic status: peer-reviewed-finding. Strength: isolates the algorithm (100,000 sock puppets) so the effect is the recommender, not the user. Limit: sock puppets are not real humans with histories, so it shows what the algorithm offers, not what real users consume.

### 8c. Trace studies: real-user extreme consumption is driven by demand, not the recommender

Claim: When you track real people's browsing, extreme-content consumption is concentrated in a small group who already hold resentful attitudes and who reach the content via subscriptions and off-platform links, not via the recommendation algorithm.

Primary source: Annie Y. Chen, Brendan Nyhan, Jason Reifler, Ronald E. Robertson, Christo Wilson, "Subscriptions and external links help drive resentful users to alternative and extremist YouTube channels," *Science Advances* 9(35): eadd8080, Aug 2023. DOI: 10.1126/sciadv.add8080.

Verbatim line (Chen et al., 2023): exposure to extremist channel videos "is heavily concentrated among a small group of people with high prior levels of gender and racial resentment."
...
## Gap 9. The reinforcement spiral and false polarization (the "detachment from reality" thread, done rigorously)

You asked for the reinforcement spiral as dissociation from reality. The rigorous, sourceable version of that intuition is two linked, peer-reviewed constructs. Clinical "dissociation" is the wrong frame and would be folklore here; "misperception of social reality" is the right one and is well established.
...
### 9b. The outcome: false polarization (the "detached from reality" payoff)

Claim: People systematically perceive the political out-group as more extreme, more homogeneous, and more hostile than it actually is; this misperception can itself feed further polarization.
...
## Gap 10. The structural foundation: collective behavior, misaligned objective, and the self-correction question

This is the scaffold the whole argument hangs from, and it has a strong peer-reviewed anchor.

### 10a. The crisis-discipline argument

Claim: Human collective behavior is a system whose information flows were shaped by natural selection, and that system has been rapidly restructured by engagement-optimizing communication technology with no objective other than ad revenue; large-scale behavioral processes cannot be assumed to be self-correcting, so the absence of stewardship should not be expected to yield stabilizing or beneficial outcomes.

Primary source: Joseph B. Bak-Coleman, Carl T. Bergstrom, et al., "Stewardship of global collective behavior," *PNAS* 118(27): e2025764118, 2021. DOI: 10.1073/pnas.2025764118.

Verbatim line (Bak-Coleman et al., 2021): "In humans, information flows were initially shaped by natural selection yet are increasingly structured by emerging communication technologies."

Verbatim line (same paper, the load-bearing one): "human social dynamics cannot be expected to yield solutions to global issues or to promote human wellbeing without evidence-based policy and ethical stewardship."
...
Claim: Algorithmic personalization (targeting, profiling) isolates individuals into separate informational environments, which the authors term "epistemic fragmentation." This isolation does not just harm individuals; it disables the collective mechanisms (sharing, comparing, monitoring) by which the harm would otherwise be detected and corrected. Both natural correction strategies fail precisely because they do not address the fragmentation.

Primary source: Silvia Milano, Brent Mittelstadt, Sandra Wachter & Christopher Russell, "Epistemic fragmentation poses a threat to the governance of online targeting," *Nature Machine Intelligence* 3: 466–472, 2021. DOI: 10.1038/s42256-021-00358-3.

Verbatim line (Milano et al., 2021): online targeting "isolates individual consumers, causing what we call epistemic fragmentation," which "inflicts structural damage to the public forum."

Verbatim reflexive line (same paper): the two natural correction strategies "fail because even sophisticated individual consumers are vulnerable in isolation," and both limitations are attributed to "their failure to address epistemic fragmentation."

Epistemic status: peer-reviewed-finding (Nature Machine Intelligence Perspective, peer-reviewed). This is the citation that converts the structural argument's Plank 5 from synthesis to sourced.

### 11b. The rigorous definition (hermeneutical-injustice framing)

Claim: Epistemic fragmentation is a structural feature of algorithmic environments that isolates individuals and depletes shared epistemic resources, making it harder for people to make sense of, name, and contest emerging harms.

Primary source: Silvia Milano & Carina Prunkl, "Algorithmic profiling as a source of hermeneutical injustice," *Philosophical Studies*, 2024. DOI: 10.1007/s11098-023-02095-2.

Verbatim line (Milano & Prunkl, 2024): epistemic fragmentation is "a structural characteristic of algorithmically-mediated environments that isolate individuals, making it more difficult to develop, uptake and apply new epistemic resources."

Verbatim line (same paper): individuals "are left more vulnerable by the inability to share, compare and learn from shared experiences."

Epistemic status: peer-reviewed-finding, built on Miranda Fricker's established concept of hermeneutical injustice and C. Thi Nguyen's "Echo chambers and epistemic bubbles" (Episteme, 2020).
...
## Gap 12. Ranking-specific causal evidence and the honest aggregate picture

These two close the loop between the structural argument and the empirical base: one shows feed ranking causally shapes belief and consensus (the ranking analog of epistemic fragmentation); the other is the largest evidence synthesis, giving the fair overall picture.
...
Verbatim line (Burton et al.): content-curating algorithms "can also bring about harms when their objectives are misaligned with user values and welfare."

Verbatim finding (same paper): in a preregistered two-wave experiment (total N = 1,500), "simple changes to how posts are sampled and ranked can affect the beliefs people form," with measurable differences in belief accuracy and consensus.

Epistemic status: peer-reviewed-finding (CHI is peer-reviewed; CogSci proceedings peer-reviewed). Strength: isolates the ranking rule as the causal variable. Limit: a constructed collaborative-filtering environment, not a live commercial feed; the constructive (bridging/intelligence-based) result shows the harm is objective-dependent, not intrinsic to ranking.

### 12b. The largest evidence synthesis (the fair overall picture)

Claim: Across 496 studies, digital media use shows directionally mixed, context-dependent associations: detrimental for trust, polarization, and populism (especially in established democracies); beneficial for participation and knowledge (especially in emerging democracies and autocracies).

Primary source: Philipp Lorenz-Spreen, Lisa Oswald, Stephan Lewandowsky & Ralph Hertwig, "A systematic review of worldwide causal and correlational evidence on digital media and democracy," *Nature Human Behaviour* 7: 74–101, 2023. DOI: 10.1038/s41562-022-01460-1.

Verbatim line (Lorenz-Spreen et al., 2023): associations such as "declining political trust, increasing populism and growing polarization, are likely to be detrimental to democracy and were more pronounced in established democracies."

Verbatim structural line (same paper): platforms "typically do not create content; instead, their power lies in providing and governing a digital infrastructure" with "largely frictionless interaction between users."

Epistemic status: peer-reviewed-finding (systematic review, preregistered protocol). This is the honest backdrop: use it to make the narrow claim ("platforms degrade the specific variables collective correction depends on") rather than the overclaim ("platforms uniformly harm"). Note the review separately cites Bak-Coleman 2021 as the framing for platform power over information flow.
...
### 13a. The internal slide (the admission)

Claim: An internal 2019 Instagram research slide stated, in its own headline, that the platform worsens body-image issues for one in three teen girls who experience those issues.

Primary source: Internal Instagram research deck (2019), released by Meta with annotations on Sept 29, 2021 ("Instagram Teen Annotated Research Deck"), and quoted in the Wall Street Journal's "The Facebook Files" (Wells, Horwitz & Seetharaman, Sept 14, 2021). The line is also reproduced verbatim in a shareholder proposal in Meta's own SEC DEF 14A proxy filing (2023).

Verbatim line (internal Meta slide, 2019): "We make body image issues worse for one in three teen girls."
...
### 14a. What the filing alleges

Claim: In an internal 2019–2020 study code-named "Project Mercury," Meta (with survey firm Nielsen) measured the effect of deactivating Facebook, and found that users who stopped for a week reported lower depression, anxiety, loneliness, and social comparison; a staff researcher internally affirmed the result was causal; Meta did not publish, attributed the finding to the "existing media narrative," and (plaintiffs allege) later told Congress it could not quantify whether its products harmed teen girls.

Primary source: Unredacted brief filed by Motley Rice, In re: Social Media Adolescent Addiction/Personal Injury Products Liability Litigation, U.S. District Court, Northern District of California, filed ~Nov 21, 2025. Reported consistently by Reuters, CNBC, and UPI (Nov 23–24, 2025). A hearing on the filing was set for Jan 26, 2026.

Verbatim line (internal Meta document, per the filing): people who stopped using Facebook "for a week reported lower feelings of depression, anxiety, loneliness and social comparison."

Verbatim line (Meta staff researcher, per the filing): "The Nielsen study does show causal impact on social comparison" (followed by an unhappy-face emoji).
...
Verbatim line (Stone, to CNBC): the allegations "rely on cherry-picked quotes and misinformed opinions in an attempt to present a deliberately misleading picture."

Verbatim line (Stone, on X, characterizing the study's finding): "people who believed using Facebook was bad for them felt better when they stopped using it ... it doesn't show anything about the actual effect of using the platform."

Epistemic status: on-record company rebuttal. The expectation-effects objection is a genuine methodological concern (an unblinded deactivation study cannot easily separate the effect of leaving from the effect of believing leaving helps). Represent it at full strength.
...
The same filing makes several adjacent allegations that, if borne out, reinforce the structural argument: that Meta "recognized that optimizing its products to increase teen engagement resulted in serving them more harmful content, but did so anyway," and designed some youth-safety features to be little-used. Tag these identically: alleged in a 2025 filing, disputed by Meta, not adjudicated. They are corroboration of the engagement-vs-welfare misalignment (Plank 2), not independent proof.

---

## Do not use / could not source / treat as folklore

"Shadowbanning" as a documented mechanism. Researchers treat individual-level silent demotion stories as user folklore ("algorithmic imaginary"). The documented thing is category-level borderline-content demotion (item 4b). Use that instead.

Conversation-level reordering to manufacture false consensus. No primary located. Do not assert it. The defensible adjacent claim is the asymmetric-exposure / like-minded-majority finding in Nyhan et al. 2023, which is the opposite framing (people see mostly like-minded content) and is peer-reviewed.

The Polish party "80% negative" figure as a direct quotation. It is a Washington Post paraphrase of a Facebook internal report. Cite it as such; do not put it in quotation marks attributed to the party.

Palihapitiya / Parker as evidence of present-day intent. Both describe 2007–2011-era design and both faced company pushback that the firm has since changed. Use them for "designers knew and intended the loop," not for "this is how Meta operates in 2026."

Kramer et al. as proof of mood change. It measured the valence of words in posts (LIWC), the authors' operationalization of emotion, not measured internal affect. Say "shifted the emotional tone of what people posted," not "made people sadder."

Any claim that the 2020 Meta studies prove algorithms are harmless. They prove short-term feed swaps didn't move stable attitudes; they explicitly do not claim social media has no negative effects (Nyhan, in Science coverage: "No one is saying this means that social media has no negative effects"), and the break-glass-changes critique and the 2026 X study cut against an over-strong reading.

"The algorithm radicalizes the average user down a rabbit hole." The trace-study evidence (Chen et al. 2023, Hosseinmardi et al. 2021/2024) does not support this for the average user post-2019. The defensible claim is choice-architecture tilt plus a vulnerable subset, not mass radicalization. Use gap 8d framing.

Clinical "dissociation" / "detachment from reality" / "brain rot." No primary supports a clinical claim. Replace with "false polarization" / "misperception of social reality" (gap 9b), which is peer-reviewed. Keep the scope to social reality, not psychiatric dissociation.

The "63 break-glass changes" figure. Currently sourced to the Science correspondence and a TechPolicy.Press primer, not to a Meta primary. Use it as a reported critique, not an established count, until the primary is located.
