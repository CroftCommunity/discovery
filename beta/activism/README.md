...
| `platform-extraction-and-captured-labor.md` | The extraction strand of the harm case (T35), distinct from the relational-field/attention strand: captured community labor (unpaid moderators as platform value), enshittification read as an indictment (funded phase then extraction phase), and data opacity / lock-in as the mechanism that makes exit costly. Also carries the related surveillance-advertising plank: real-time bidding's bidstream as a security attack surface (malvertising, the *Loser's Data Loophole*, the 2024 FTC location-broker actions). Counter-evidence at full strength (CONTESTED markers; the non-extractive exceptions); private-platform financials [UNVERIFIED]. The descriptive dominance/lifecycle map lives in `../fenced/`. | indictment, honest-other-side |
...
- **The strongest sources** (peer-reviewed / company-primary): Bak-Coleman et al. (PNAS 2021),
  ...
  ranking-causal work, and Lorenz-Spreen et al. (NHB 2023) for the honest aggregate backdrop.
...
- **Not yet pulled** (none load-bearing): Tristan Harris to primary; the "63 break-glass changes"
  count to a Meta document; the broader ~35-study internal corpus traced from the aggregator to
  individual litigation exhibits.
