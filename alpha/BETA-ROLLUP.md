...
| CM-P1 | Roll-up trust **trilemma** + accumulator/MMR end-state. | — (DETERMINED 2026-06-26: resolved by `drystone-spec` Part 2 §7.3.3 choosing Option-A — each peer self-folds, no-trust checkpoint; accumulator/MMR noted as a minor unbuilt future direction. Not separately folded.) | `thinking/design-notes-addendum.md` §2 | closed (resolved by spec) |
| CM-P2 | The positive **"guarantee actually made"** sentence — legibility+exit, not convergence. | **FOLDED 2026-06-26** (user-approved, via the alpha left-behind audit) → **04 §1** (new ¶: Drystone does not promise membership convergence; it promises a true, attributable history + clean exit; the refused failure mode is "claiming convergence while only delivering legibility") | `thinking/design-notes-addendum.md` §6/§8 | folded |
| CM-P3 | Geer visibility-dial **3-rung enumeration** (partial: 06 §3 already says "least-invasive rung" + "other rungs remain compellable"; only the report/classifier/full-key enumeration absent). | — (DETERMINED-subsumed by 06 §3; alpha detail, not folded — alpha left-behind audit 2026-06-26) | `thinking/geer-gating-peer.md` | closed (subsumed) |
