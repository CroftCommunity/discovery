//! **Copied** from `../iroh/crates/mls-welcome-over-iroh/src/node.rs`. See `relay.rs` for why
//! this is a copy rather than a dependency. **Change from the original:** the `ALPN` constant
//! now names this spike rather than the relay lab.
//!
...
pub const ALPN: &[u8] = b"croft/meer-queue/0";
