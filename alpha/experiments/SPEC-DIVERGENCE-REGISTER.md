...
| automerge-0.6.1 | proxy-measurement | `automerge-partial-reconstruction` README | The 4 invariants are proven on **0.6.1**, not the 0.7 ship target (MSRV wall). 0.7 confirmation is open. |
