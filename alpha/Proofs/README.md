...
Both proofs were authored in `croftc/upstream-repo` (PRs #8, #9) and imported here.
upstream-repo plumbing (`.github/workflows/confluence-sync.yml`, `renovate.json`) was not
